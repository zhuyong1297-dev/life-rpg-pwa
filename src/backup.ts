import { z } from 'zod'
import { ActivitySchema, CompletionSchema, LedgerEventSchema, RewardSchema, SettingSchema, WeeklyReviewSchema, calculateStats } from './domain'
...
export const BackupSchema = z
  .object({
    ...
    appVersion: z.union([z.literal('2.0.0'), z.literal('2.1.0'), z.literal('2.2.0')]),
  ...
  .superRefine((backup, context) => {
    const expectedAppVersion = { 1: '2.0.0', 2: '2.1.0', 3: '2.2.0' }[backup.schemaVersion]
