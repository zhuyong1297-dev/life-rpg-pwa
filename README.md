...
正式入口与手机预览当前均运行 V4.0.0：体魄、智识、专注、创造、关系、心境被替换为健康、学习、创作、事业、生活、心境。首次升级需逐项确认仍可使用活动的归属；角色总 XP、金币和历史流水不变，新领域从 0 XP 开始。正式数据与预览数据继续完全隔离。

在线地址：[https://zhuyong1297-dev.github.io/life-rpg-pwa/](https://zhuyong1297-dev.github.io/life-rpg-pwa/)

正式版本：[地球 Online V4.0.0](https://github.com/zhuyong1297-dev/life-rpg-pwa/releases/tag/v4.0.0)
