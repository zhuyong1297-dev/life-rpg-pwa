...
> README v0.1 · 正式版 V5.9.0 · 预览版与正式版功能基线一致
...
- 稳定版本：[V5.9.0 Release](https://github.com/zhuyong1297-dev/life-rpg-pwa/releases/tag/v5.9.0)
...
当前正式版与预览版均运行 V5.9.0，包含双旅者与习惯启动锚点。数据契约仍为 Backup JSON schema 12、Dexie version 4 和八张表，并兼容恢复 schema 1～11。
