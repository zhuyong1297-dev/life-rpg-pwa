...
正式入口当前运行 V3.2.1：同一时间一个 28 天成长赛季、本地建议型教练和个人策略库，并修复历史完成过的习惯被误当成已完成一次性任务、从“今天”隐藏的问题。正式数据与预览数据继续完全隔离，现有正式 IndexedDB 和 schema 6 保持不变，不会清空活动或成长记录。

手机预览当前运行 V4.0.0：体魄、智识、专注、创造、关系、心境被替换为健康、学习、创作、事业、生活、心境。首次进入预览需逐项确认仍可使用活动的归属；角色总 XP、金币和历史流水不变，新领域从 0 XP 开始。
