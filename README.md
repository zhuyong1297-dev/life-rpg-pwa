...
正式入口运行 V4.0.2；手机预览正在验证 V4.1.0 的稳定生活行为系统。赛季前三天可原子安装晨间唤醒、单点开工和夜间收尾，并用每日 15 秒状态记录检验现实效果。正式数据与预览数据继续完全隔离。
...
- V4.1 预览使用 JSON schema 8，兼容恢复 schema 1 至 7；Markdown 账本用于阅读归档。
