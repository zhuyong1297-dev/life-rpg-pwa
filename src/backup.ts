...
export const BackupSchema = z
  .object({
    ...
    appVersion: z.union([z.literal('2.0.0'), z.literal('2.1.0'), z.literal('2.2.0'), z.literal('2.3.0'), z.literal('2.4.0'), z.literal('2.5.0'), z.literal('2.6.0'), z.literal('2.7.0'), z.literal('3.2.0'), z.literal('3.2.1'), z.literal('4.0.0'), z.literal('4.0.1'), z.literal('4.0.2'), z.literal('4.1.0'), z.literal('4.2.0'), z.literal('4.3.0'), z.literal('4.4.0'), z.literal('4.5.0'), z.literal('5.0.0'), z.literal('5.0.1'), z.literal('5.0.2'), z.literal('5.1.0'), z.literal('5.2.0'), z.literal('5.2.1'), z.literal('5.3.0'), z.literal('5.4.0'), z.literal('5.4.1'), z.literal('5.5.0'), z.literal('5.5.1'), z.literal('5.6.0'), z.literal('5.7.0'), z.literal('5.8.0')]),
  ...
  .superRefine((backup, context) => {
    const compatibleAppVersions: Record<number, readonly string[]> = {
      ...
      12: ['5.4.0', '5.4.1', '5.5.0', '5.5.1', '5.6.0', '5.7.0', '5.8.0'],
    }
